...
- ## Code map — which page owns which source
	...
	- `views/BoardView.vue`, `components/KanbanColumn.vue`, `components/TaskCard.vue`, `components/ColumnSettingsModal.vue` → [[Board View]]
	...
	- `views/PracticeView.vue`, `components/Practice*.vue`, `stores/practiceSessionStore.ts` → [[Practice Companion View]]
